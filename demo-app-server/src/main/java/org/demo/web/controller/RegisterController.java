...
import org.demo.web.service.EmailService;
import org.demo.web.service.UserService;
...
public class RegisterController {
	...
	public ModelAndView processRegistrationForm(ModelAndView modelAndView, @Valid User user, BindingResult bindingResult, HttpServletRequest request) {
		...
		if (bindingResult.hasErrors()) { 
			System.out.println("THERE WAS AN ERROR PROCESSING REGISTRATION...."+bindingResult.getAllErrors());
			modelAndView.setViewName("register");		
		    ...
		    System.out.println("request scheme "+request.getServerName());
